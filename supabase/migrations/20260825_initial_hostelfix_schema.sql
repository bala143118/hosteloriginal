-- ============================================================================
-- HostelFix Comprehensive Supabase Database Setup (Clean & Safe)
-- ============================================================================
...
-- Clean up any conflicting older schemas
...
create index idx_complaints_student_email on public.complaints(student_email);
...
create index idx_gate_passes_student_id on public.gate_passes(student_id);
create index idx_gate_passes_status on public.gate_passes(status);
create index idx_gate_passes_departure_date on public.gate_passes(departure_date);
...
create index idx_laundry_student_email on public.laundry_requests(student_email);
create index idx_laundry_status on public.laundry_requests(status);
create index idx_laundry_created_at on public.laundry_requests(created_at desc);
...
create index idx_announcements_target_email on public.announcements(target_email);
...
create index idx_security_events_event_id on public.security_events(event_id);
